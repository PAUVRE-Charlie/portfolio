      ...
      <Container>
        <div className={style.intro}>
          <div className={style.preview}>
            ...
            <img
              ...
              src={`../../assets/images/${project}/preview.png`}
              alt="preview"
            />
          </div>
          <div className={style.info}>
            ...
            <div>
              {en.projects[project].web && (
                ...
                >
                  <button>
                    <Text id="project.launchWeb" />
                  </button>
                </a>
              )}
              {en.projects[project].github && (
                <a
                  href={en.projects[project].github}
                  rel="noreferrer"
                  target="_blank"
                >
                  <img src={github_medium} alt="github" />
                </a>
              )}
            </div>
          </div>
        ...
        <div className={style.details}>
          <div className={style.context}>
            <h2>
              <Text id="project.context.title" />
            </h2>
            <p>
              <Text id={`projects.${project}.context`} />
            </p>
          </div>
          <div className={style.infos}>
            <div>
              <h3>
                <Text id="project.context.date" />
              </h3>
              <p>
                <Text id={`projects.${project}.date`} />
              </p>
            </div>
            {en.projects[project].company && (
              <div>
                <h3>
                  <Text id="project.context.company" />
                </h3>
                <p>
                  <Text id={`projects.${project}.company`} />
                </p>
              </div>
            )}
            {en.projects[project].team && (
              <div>
                <h3>
        ...
        <div className={style.process}>
          <h2>
            <Text id="project.process.title" />
          </h2>
          {en.projects[project].process.map((_, i) => (
            <div>
              <h4>👉🏻</h4>
              <p>
                <Text id={`projects.${project}.process.${i}`} />
              </p>
            </div>
          ))}
        </div>
          ...
          <div className={style.skills}>
            {(project === "tgeu"
              ...
              <Skill
                ...
                imageSize="120%"
                shape={images.shape1}
                title={<Text id={`projects.${projectName}.name`} />}
                description={
                  <Text id={`projects.${projectName}.smallDescription`} />
                }
              />
            ))}
          </div>
